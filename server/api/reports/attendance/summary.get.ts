...
export default defineEventHandler(async event => {
  ...
  if (query.nodeId) {
    ...
    const scopedDojos = await db.query.dojos.findMany({ where: eq(tables.dojos.organizationId, organizationId) })
