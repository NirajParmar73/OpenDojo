<template>
  <div class="mx-auto max-w-7xl">
    ...
    <section v-if="selectedOrganization" class="mt-6 rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
      <div class="flex items-start justify-between gap-4"><div><h2 class="font-semibold">Manage {{ selectedOrganization.name }}</h2><p class="mt-1 text-sm text-slate-500">Type the workspace slug to authorize permanent deletion.</p></div><UButton size="sm" variant="ghost" @click="selectedOrganization = null; void 0">Close</UButton></div>
